        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInPlace = table.Column<bool>(type: "bit", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18, 2)", nullable: true),
                    VolumeId = table.Column<int>(type: "int", nullable: false),
                    YearOfPurchase = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AltGenreId = table.Column<int>(type: "int", nullable: true),
                    AltWorkKindId = table.Column<int>(type: "int", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GenreId = table.Column<int>(type: "int", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VolumeId = table.Column<int>(type: "int", nullable: true),
                    WorkKindId = table.Column<int>(type: "int", nullable: true),
                    YearOfCompletion = table.Column<int>(type: "int", nullable: true),
                    YearOfFirstPublication = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
